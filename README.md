...
- [x] Forgejo Actions runner: dedicated `forgejo-runner` user, own rootless
      Podman, instance-wide registration. Verified end to end — a real
      workflow checks out and runs on it. `repos/servers/hosts/hades-runner/`
